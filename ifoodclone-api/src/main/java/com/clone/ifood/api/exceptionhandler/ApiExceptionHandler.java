package com.clone.ifood.api.exceptionhandler;
...
import com.clone.ifood.domain.exception.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	private static final String MSG_ERRO_GENERICA_USUARIO_FINAL = "Ocorreu um erro interno inesperado no sistema."
			+ " Tente novamente e se o problema persistir, entre em contado com o administrador.";
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatchException(
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s, que é um tipo inválido."
				+ "Corrija e informe um valor compatível com '%s'", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName());
